...
builder.Services.AddControllers(opt => opt.Filters.Add<CommanResponseResultFilter>());
...
{
    opt.SwaggerDoc("v1", new OpenApiInfo { Title = "CPM.API", Version = "v1" });
